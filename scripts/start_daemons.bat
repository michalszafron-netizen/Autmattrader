...
start /min "Volume Scanner"   cmd /k "cd /d C:\Users\markowyy\trading-ai && .venv\Scripts\python.exe scripts\volume_scanner.py --daemon --interval 10800 --threshold 5 --no-futures"
...
start /min "TV Webhook"     cmd /k "cd /d C:\Users\markowyy\trading-ai && .venv\Scripts\python.exe scripts\tv_webhook.py --port 5005"
